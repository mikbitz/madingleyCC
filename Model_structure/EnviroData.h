...
//            {
//                _Lats[ii] = _LatMin + (ii * cellSize);
//            }
//            for (int jj = 0; jj < _NumLons; jj++)
//            {
//                _Lons[jj] = _LonMin + (jj * cellSize);
//            }
//
//            _LatStep = Lats[1] - _Lats[0];
//            _LonStep = Lons[1] - Lons[0];
//
...
//            }
//
//            //If haven't found the ClosestUpperLatIndex then this is because the grid cells are exactly overlapping
//            if (ClosestUpperLatIndex == -1)
//            {
//                // So take the ShortestUpperLatDistance as 0 
//                ShortestUpperLatDistance = 0.0;
//                // and set the ClosestUpperLatIndex equal to the ClosestLowerLatIndex
//                ClosestUpperLatIndex = ClosestLowerLatIndex;
//            }
//
...
@param internalData The SDS object to get data from 
@param dataName The name of the variable within the NetCDF file 
@param latInverted Whether the latitude values are inverted in the NetCDF file (i.e. large to small values) 
@param longInverted Whether the longitude values are inverted in the NetCDF file (i.e. large to small values) 
*/
