...
//            double LeafMortFrac = this.CalculateLeafFracAllocation(LeafMortRate, 
//                this.CalculateDeciduousAnnualLeafMortality(MeanTemp),
//                this.CalculateEvergreenAnnualLeafMortality(MeanTemp),FracEvergreen, FRootMort);
//
...
//            double FracLeaves = FracNonStruct * this.CalculateLeafFracAllocation(AnnualLeafMortRate, this.CalculateDeciduousAnnualLeafMortality(cellEnvironment["Temperature"].Average()),
//                this.CalculateEvergreenAnnualLeafMortality(cellEnvironment["Temperature"].Average()),FracEvergreen, AnnualFRootMort);
//
//
//            // Update NPP depending on whether the acting stock is deciduous or evergreen
//            if (deciduous)
...
//        {
//
//            double CombinedLeafMortRate = Math.Exp((FracEvergreen * Math.Log(EvergreenLeafMortRate)) + ((1 - FracEvergreen) * Math.Log(DecidLeafMortRate)));
//
