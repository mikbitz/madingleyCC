...
public:
    ...
    //----------------------------------------------------------------------------------------------
    /** \brief  Run ecological processes that operate across grid cells, for a particular grid cell. These should always occur after the within grid cell processes
     */
    ...
    //----------------------------------------------------------------------------------------------
    /** \brief  Update the properties of all cohorts across all grid cells
     */
