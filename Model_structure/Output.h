...
*/
@param textDetail The level of detail required in the textual output: 'Low', 'Medium' or 'High' 
//         Output(string textDetail, bool gridView)
//        {
...
@param gridView Whether to launch dataset viewer in full model grid view (otherwise in graph view) 
...
//            FunctionalGroupDefinitions StockFunctionalGroupDefinitions, unsigned NumTimeSteps, string FileOutputs)
//        {
...
@param _LatCellIndices A vector of the latitudinal indices of live cells in the model grid 
@param _LonCellIndices A vector of the longitudinal indices of live cells in the model grid 
@param GlobalDiagnosticVariables The sorted list of global diagnostic variables in the model 
//         void CalculateOutputs(ModelGrid EcosystemModelGrid, FunctionalGroupDefinitions CohortFunctionalGroupDefinitions, 
//            FunctionalGroupDefinitions StockFunctionalGroupDefinitions, unsigned[] _LatCellIndices, unsigned[] _LonCellIndices, map<string, double> 
...
//            foreach (unsigned ii in _LatCellIndices)
//            {
//                foreach (unsigned jj in _LonCellIndices)
//                {
...
@param _LatCellIndices The latitudinal indices of live cells in the model 
@param _LonCellIndices The longitudinal indices of live cells in the model 
...
//            FunctionalGroupDefinitions StockFunctionalGroupDefinitions, unsigned[] _LatCellIndices, unsigned[] _LonCellIndices, map<string, double> 
//            GlobalDiagnosticVariables, unsigned NumTimeSteps)
//        {
...
@param _LonCellIndices The longitudinal indices of live cells in the model 
@param GlobalDiagnosticVariables List of global diagnostic variables 
@param TimeStepTimer Stopwatch instance for calculating the time to run each time step 
@param NumTimeSteps The number of time steps in the model run 
...
//            StockFunctionalGroupDefinitions, unsigned[] _LatCellIndices, unsigned[] _LonCellIndices, map<string, double> GlobalDiagnosticVariables,
//            StopWatch TimeStepTimer, unsigned NumTimeSteps, unsigned currentTimestep)
//        {
//            // Calculate values of the output variables to be used
