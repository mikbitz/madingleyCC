...
class IMortalityImplementation
    {
    public:
/** \brief Time units associated with the formulation of mortality */
        //StringProperty TimeUnitImplementation;
//
/** \brief Scalar to convert from time units associated with mortality to the global model time step unit */
