...
//         Tuple<double[], double, double> MonthlyActualEvapotranspirationSoilMoisture(double AvailableWaterCapacity, double[] Precipitation, double[] MonthlyTemperatures)
//        {
...
//         double GetNDF(double[] monthlyFrostDays, double[] monthlyTemperature, double missingValue)
//        {
